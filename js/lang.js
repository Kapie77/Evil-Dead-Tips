...
const translations = {
  ...
  pt: {
    ...
    /* Amanda */
    amandaspecialtitle1: "Munição Pra Dias",
    amandaspecialtitle2: "Arma Secundária Confiável",
    amandaspecialtitle3: "Maestria de Arma: Pistola",
    amandaspecialtitle4: "Acurácia Conta",
    amandaspecialhability1: "Quando ativada, essa habilidade permite que você dispare temporariamente suas armas de longo alcance sem gastar munição.",
    amandaspecialhability2: "Comece a partida com uma pistola.",
    amandaspecialhability3: "A Pistola tem uma velocidade de recarga mais rápida e causa mais dano à saúde, à barra de equilíbrio e de desmembramento.",
    amandaspecialhability4: "O dano causado pelas suas armas de longo alcance aumenta a cada acerto consecutivo.",
...
// Traduções das dicas sobreviventes //
if (typeof survivorstipsTranslations !== "undefined") {
    Object.assign(translations.pt, survivorstipsTranslations.pt);
    Object.assign(translations.en, survivorstipsTranslations.en);
    Object.assign(translations.es, survivorstipsTranslations.es);
}

// Traduções das classes //
if (typeof classesTranslations !== "undefined") {
    Object.assign(translations.pt, classesTranslations.pt);
